...
This example shows how to package an algorithm for use with SageMaker. We have chosen a simple implementation of [prophet][prophet].
...
* __prophet__: The directory that contains the application to run in the container. See the next session for details about each of the files.
...
* __input/data/training/shop.csv__: The training data.
